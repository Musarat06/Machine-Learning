# Machine Learning: Predicting Bike Sharing Rental Count
...
To run the notebooks and scripts in this repository, you need to have Python and Jupyter Notebook installed. You can install the necessary dependencies using the following command:
